...
public class KnowledgeAttachController extends BaseController {
    ...
    @Log(title = "课程资料审核", businessType = BusinessType.UPDATE)
    @RepeatSubmit()
    @PostMapping("/audit/{id}")
    public R<Void> audit(@PathVariable Long id, @Validated @RequestBody KnowledgeAttachAuditBo bo) {
        return toAjax(knowledgeAttachService.audit(id, bo));
    }
}
